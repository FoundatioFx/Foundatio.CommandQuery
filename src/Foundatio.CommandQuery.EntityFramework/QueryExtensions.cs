...
public static class QueryExtensions
{
    ...
    /// </code>
    /// </example>
    public static IQueryable<T> Sort<T>(this IQueryable<T> query, QuerySort? sort)
    {
        if (sort == null)
            return query;
    ...
    /// </code>
    /// </example>
    public static IQueryable<T> Sort<T>(this IQueryable<T> query, IEnumerable<QuerySort>? sorts)
    {
        if (sorts?.Any() != true)
            return query;
        ...
        foreach (var sort in sorts)
        {
            ...
            builder.Append(' ');
            builder.Append(sort.Descending ? "desc" : "asc");
        }
