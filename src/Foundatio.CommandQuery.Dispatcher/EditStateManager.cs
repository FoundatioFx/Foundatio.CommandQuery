...
/// <remarks>
/// <para>
/// The <see cref="EditStateManager{TKey, TReadModel, TUpdateModel}"/> class is designed for complex editing scenarios where you need
...
/// from the data store, while the <see cref="StateManager{TModel}.Model"/> property contains the editable update model.
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EditStateManager{TKey, TReadModel, TUpdateModel}"/> class.
    /// </summary>
    ...
    /// </exception>
    public EditStateManager(IDispatcherDataService dataService, IMapper mapper)
    {
    ...
    /// <list type="number">
    /// <item>Sets the <see cref="StateManager{TModel}.Model"/> property to the provided update model</item>
    ...
    /// <item>Triggers the <see cref="StateManager{TModel}.OnStateChanged"/> event</item>
    /// </list>
    /// </para>
    /// <para>
    ...
    /// </summary>
    /// <remarks>
    /// This method resets the <see cref="StateManager{TModel}.Model"/>, <see cref="Original"/>, and <see cref="EditHash"/>
    /// properties and triggers the <see cref="StateManager{TModel}.OnStateChanged"/> event to notify subscribers.
    /// </remarks>
    ...
    /// <list type="number">
    /// <item><see cref="IsBusy"/> is set to <c>true</c> and <see cref="StateManager{TModel}.NotifyStateChanged"/> is called</item>
    ...
    /// <item><see cref="IsBusy"/> is reset to <c>false</c> and <see cref="StateManager{TModel}.NotifyStateChanged"/> is called again</item>
    /// </list>
    /// </para>
    /// <para>
    ...
    /// If either <see cref="StateManager{TModel}.Model"/> or <see cref="Original"/> is <c>null</c>, the method returns without performing any operation.
    /// </para>
    /// <para>
    ...
    /// <item>The <see cref="StateManager{TModel}.Model"/> property is set to the converted update model</item>
