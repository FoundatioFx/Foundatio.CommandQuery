...
public static class ServiceExtensions
{
    ...
    public static IServiceCollection AddRemoteDispatcher(this IServiceCollection services)
    {
        ...
        services.Add(ServiceDescriptor.Scoped(typeof(StateManager<>), typeof(StateManager<>)));
        services.Add(ServiceDescriptor.Scoped(typeof(ReadStateManager<,>), typeof(ReadStateManager<,>)));
        services.Add(ServiceDescriptor.Scoped(typeof(EditStateManager<,,>), typeof(EditStateManager<,,>)));
