...
public class QueryFilterConverter : JsonConverter<QueryFilter>
{
    ...
    private static void ReadValue(ref Utf8JsonReader reader, QueryFilter value, JsonSerializerOptions options)
    {
        ...
        {
            value.Operator = TryParseEnum<QueryOperators>(propertyValue);
        }
        else if (TryReadStringProperty(ref reader, Logic, out propertyValue))
        {
            value.Logic = TryParseEnum<QueryLogic>(propertyValue);
        }
    ...
    private static bool TryReadFiltersProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, out List<QueryFilter>? value)
    {
        ...
        {
            value = JsonSerializer.Deserialize<List<QueryFilter>>(ref reader, options);
            return true;
        }
    ...
    public override void Write(Utf8JsonWriter writer, QueryFilter value, JsonSerializerOptions options)
    {
        ...
        WriteQueryFilter(writer, value, options);
        writer.WriteEndObject();
    }

    private static void WriteQueryFilter(Utf8JsonWriter writer, QueryFilter value, JsonSerializerOptions options)
    {
