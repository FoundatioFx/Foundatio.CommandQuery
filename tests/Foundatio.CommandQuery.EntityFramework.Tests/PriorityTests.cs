...
public class PriorityTests : DatabaseTestBase
{
    ...
    public async Task FullTest()
    {
        ...
        // get entity
        var getCommand = new GetEntity<int, PriorityReadModel>(MockPrincipal.Default, created.Id);
        ...
        var updateCommand = new UpdateEntity<int, PriorityUpdateModel, PriorityReadModel>(MockPrincipal.Default, created.Id, updateRequest);
        ...
        // delete entity
        var deleteCommand = new DeleteEntity<int, PriorityReadModel>(MockPrincipal.Default, created.Id);
    ...
    public async Task GetEntity()
    {
        ...
        var getCommand = new GetEntity<int, PriorityReadModel>(MockPrincipal.Default, PriorityConstants.Normal.Id);
        var getResult = await mediator.InvokeAsync<Result<PriorityReadModel>>(getCommand);
        getResult.Should().NotBeNull();
    ...
    public async Task GetEntities()
    {
        ...
        var command = new GetEntities<int, PriorityReadModel>(MockPrincipal.Default, ids);
