...
public partial class TenantMap
    : IEntityTypeConfiguration<Entities.Tenant>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.Tenant> builder)
    {
        // table
