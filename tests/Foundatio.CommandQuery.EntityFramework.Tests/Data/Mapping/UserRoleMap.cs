...
public partial class UserRoleMap
    : IEntityTypeConfiguration<Entities.UserRole>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.UserRole> builder)
    {
        // table
