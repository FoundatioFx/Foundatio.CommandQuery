...
public partial class PriorityMap
    : IEntityTypeConfiguration<Entities.Priority>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.Priority> builder)
    {
        // table
