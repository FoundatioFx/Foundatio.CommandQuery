...
public class EditStateManagerTests
{
    [Fact]
    public void Constructor_WithValidParameters_ShouldInitializeCorrectly()
    {
        ...
        // Act
        var manager = new EditStateManager<int, TestReadModel, TestUpdateModel>(dataService, mapper);
    ...
    public void Constructor_WithNullDataService_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        var action = () => new EditStateManager<int, TestReadModel, TestUpdateModel>(null!, mapper);
    ...
    public void Constructor_WithNullMapper_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        var action = () => new EditStateManager<int, TestReadModel, TestUpdateModel>(dataService, null!);
