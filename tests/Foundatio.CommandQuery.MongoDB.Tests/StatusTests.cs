...
public class StatusTests : DatabaseTestBase
{
    ...
    public async Task FullTest()
    {
        ...
        // get entity
        var getCommand = new GetEntity<string, StatusReadModel>(MockPrincipal.Default, created.Id);
        ...
        var updateCommand = new UpdateEntity<string, StatusUpdateModel, StatusReadModel>(MockPrincipal.Default, created.Id, updateRequest);
        ...
        // delete entity
        var deleteCommand = new DeleteEntity<string, StatusReadModel>(MockPrincipal.Default, created.Id);
