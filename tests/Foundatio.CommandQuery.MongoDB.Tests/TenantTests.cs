...
public class TenantTests : DatabaseTestBase
{
    ...
    public async Task FullTest()
    {
        ...
        // get entity
        var getCommand = new GetEntity<string, TenantReadModel>(MockPrincipal.Default, created.Id);
        ...
        var updateCommand = new UpdateEntity<string, TenantUpdateModel, TenantReadModel>(MockPrincipal.Default, created.Id, updateRequest);
        ...
        // delete entity
        var deleteCommand = new DeleteEntity<string, TenantReadModel>(MockPrincipal.Default, created.Id);
